package com.temp.common.security.service;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import com.temp.common.constant.RedisConstants;
...
public class PermissionService {
    ...
    public Set<String> getRolePermsFormCache(Set<String> roleCodes) {
        ...
        List<Object> rolePermsList = redisTemplate.opsForHash().multiGet(RedisConstants.ROLE_PERMS_PREFIX,
                roleCodesAsObjects);
