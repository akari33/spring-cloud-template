...
public class Generator {
    ...
    public static void main(String[] args) {
        //获取指定输出目录../com.temp
        String outputDir =
                System.getProperty("user.dir") + "/temp-common/common-mbp-single/src/main/java";
        //获取xml存放目录
        String xmlOutputDir =
                System.getProperty("user.dir") + "/temp-common/common-mbp-single/src/main/resources/com/temp/mapper";
        //获取配置文件
